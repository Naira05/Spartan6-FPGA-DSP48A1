...
set perspective_DateTime   {2025-08-03T20:11:03}
set perspective_Directory  {E:/digital_design_course/DSP_Project/Spartan6-FPGA-DSP48A1}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinlintDesignMetricsView,zinlintMsgDashboardView,zinmsgviewer,zinlintMsgStatusHistoryView,zinlintMsgView,transcript,zinlintDesignInfoView,source,zincdcdutview,zinlintMsgSummaryView,zinflownavigator,zinschematicview -hide -description none -label none
